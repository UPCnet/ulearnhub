...
ulearnhub.controller('DeploymentsController', ['$modal', '$log', 'Domain', 'DTOptionsBuilder', 'DTColumnDefBuilder','$cookies','DTTranslations', function($modal, $log, Domain, DTOptionsBuilder, DTColumnDefBuilder,$cookies,DTTranslations) {
    var self = this;
